...
<template>
  ...
  <header id="moblile">
    <section>
      <img v-on:click="toogleMenu()" id="logo_sb_mobile" src="/images/logo_sbfoodtech-branco.png"
        alt="Logo SB Foodtechs" />
    </section>
    <nav>
...
@media (min-width: 501px) {
  ...
  #decktop:hover section:first-child {
