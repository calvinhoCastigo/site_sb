...
export default {
    ...
    data() {
        ...
        const areasDeAtuacaoComProjeto = [
            {
                id: 1,
                nome: "Restaurantes",
                projetos:[
                ...
                Também trabalhamos com a premissa de separar as praças, ou seja: temos uma sala  exclusiva para preparos de sucos, saladas e sobremesas, outra sala para lavagem de louças, outra para porcionamento de carnes, ultracongelamentos e por fim, a de finalização dos pratos com vista para os clientes!`,
                        imagens: [
                            "projetos/brasido/img (1).jpg",
                            "projetos/brasido/img (2).jpg",
                            "projetos/brasido/img (3).jpg"
                        ],
                        areaDeAtucaoId: 1,
                        ano: 2022
                    }, {
                        ...
                        imagens: [
                            "projetos/emma gastrobar/img (1).jpg",
                            "projetos/emma gastrobar/img (2).jpg",
                            "projetos/emma gastrobar/img (3).jpg",
                            "projetos/emma gastrobar/img (4).jpg",
                            "projetos/emma gastrobar/img (5).jpg",
                            "projetos/emma gastrobar/img (6).jpg"
                        ],
                        areaDeAtucaoId: 1,
                        ano: 2023
                    }, {
                ...
                O resultado foi uma cozinha esteticamente limpa e minimalista e aberta aos olhos do público, que poderá acompanhar os preparos de suas refeições.`,
                        imagens: [
                            "projetos/japidinho/img (1).jpg",
                            "projetos/japidinho/img (2).jpg",
                            "projetos/japidinho/img (3).jpg",
                            "projetos/japidinho/img (4).jpg",
                            "projetos/japidinho/img (5).jpg",
                            "projetos/japidinho/img (6).jpg",
                            "projetos/japidinho/img (7).jpg",
                            "projetos/japidinho/img (9).jpg",
                            "projetos/japidinho/img (10).jpg",
                            "projetos/japidinho/img (11).jpg"
                        ],
                        areaDeAtucaoId: 1,
                        ano: 2023
                    },
                    {
                        ...
                        imagens: [
                            "projetos/pata de vaca/img (1).jpg",
                            "projetos/pata de vaca/img (2).jpg",
                            "projetos/pata de vaca/img (3).jpg",
                            "projetos/pata de vaca/img (4).jpg",
                            "projetos/pata de vaca/img (5).jpg",
                            "projetos/pata de vaca/img (6).jpg",
                            "projetos/pata de vaca/img (7).jpg",
                            "projetos/pata de vaca/img (8).jpg",
                            "projetos/pata de vaca/img (9).jpg",
                            "projetos/pata de vaca/img (10).jpg"
                        ],
                        areaDeAtucaoId: 1,
                        ano: 2024
                    }, {
                ...
                Dessa maneira, optamos por fazer uma redução de 30% da área da cozinha, transformando-a em salão e aumentando a quantidade de assentos. Também reestruturamos todo o fluxo e praças da cozinha para que as colaboradoras não precisem fazer movimentações, mantendo a eficiência e rapidez na cozinha.`,
                        imagens: [
                            "projetos/restaurante verde vale/img (1).jpg",
                            "projetos/restaurante verde vale/img (2).jpg",
                            "projetos/restaurante verde vale/img (3).jpg",
                            "projetos/restaurante verde vale/img (4).jpg",
                            "projetos/restaurante verde vale/img (5).jpg",
                            "projetos/restaurante verde vale/img (6).jpg",
                            "projetos/restaurante verde vale/img (7).jpg",
                            "projetos/restaurante verde vale/img (8).jpg"
                        ],
                        areaDeAtucaoId: 1,
                        ano: 2024
                    }, {
                ...
                O grande desafio neste projeto foi conciliar o novo espaço com o aproveitamento de 100% dos equipamentos e mobiliários já existentes, o que possibilitou uma grande economia para o cliente! O resultado foi um projeto de rápida execução e muita funcionalidade!A Paninoteca é uma casa especializada em paninis e especialidades italianas! Em 2024, precisaram mudar de endereço e realocar a sua cozinha profissional em um espaço reduzido, mas que fosse funcional. Dessa forma, aproveitamos todos os equipamentos  e mobiliários que já eram existentes, promovendo uma grande economia para o cliente, mas trazendo toda a funcionalidade que a operação necessita!`,
                        imagens: [
                            "projetos/nazca sushi/img (1).png",
                            "projetos/nazca sushi/img (2).png",
                            "projetos/nazca sushi/img (3).png",
                            "projetos/nazca sushi/img (4).png",
                            "projetos/nazca sushi/img (5).png",
                            "projetos/nazca sushi/img (6).png",
                            "projetos/nazca sushi/img (7).png",
                            "projetos/nazca sushi/img (8).png"
                        ],
                        areaDeAtucaoId: 1,
                        ano: 2024
                    }
                ...
                projetos:[
                    {
                        ...
                        imagens: [
                            "projetos/la cerva/img (1).jpg",
                            "projetos/la cerva/img (2).jpg",
                            "projetos/la cerva/img (3).jpg"
                        ],
                        areaDeAtucaoId: 2,
                        ano: 2021
                    }, {
                        ...
                        imagens: [
                            "projetos/farol bar/img (1).jpg",
                            "projetos/farol bar/img (2).jpg"
                        ],
                        areaDeAtucaoId: 2,
                        ano: 2023
                    }
            ...
            },
            {
                ...
                Essa central abrigará toda a produção de pães, salgados, confeitarias e rotisserias de todas as lojas Curió. Os produtos serão enviados já embalados e/ou ultracongelados, mantendo segurança alimentar e qualidade dos protudos!`,
                        imagens: [
                            "projetos/supermercado curió/img (1).jpg",
                            "projetos/supermercado curió/img (2).jpg",
                            "projetos/supermercado curió/img (3).jpg",
                            "projetos/supermercado curió/img (4).jpg",
                            "projetos/supermercado curió/img (5).jpg",
                            "projetos/supermercado curió/img (6).jpg",
                            "projetos/supermercado curió/img (7).jpg",
                            "projetos/supermercado curió/img (8).jpg",
                            "projetos/supermercado curió/img (9).jpg"
                        ],
                        areaDeAtucaoId: 3,
                        ano: 2021
                    },
                    {
                        ...
                        imagens: [
                            "projetos/supermercado sorrinort/img (1).png",
                            "projetos/supermercado sorrinort/img (2).png",
                            "projetos/supermercado sorrinort/img (3).png",
                            "projetos/supermercado sorrinort/img (4).png",
                            "projetos/supermercado sorrinort/img (5).png"
                        ],
                        areaDeAtucaoId: 3,
                        ano: 2023
                    }
                ...
                projetos:[
                    {
                        ...
                        imagens: [
                            "projetos/hotel amazon aeroporto/img (1).jpg",
                            "projetos/hotel amazon aeroporto/img (2).jpg",
                            "projetos/hotel amazon aeroporto/img (3).jpg",
                            "projetos/hotel amazon aeroporto/img (4).jpg"
                        ],
                        areaDeAtucaoId: 4,
                        ano: 2021
                    },
                    {
                        ...
                        imagens: [
                            "projetos/hotel rossi/img (1).jpg",
                            "projetos/hotel rossi/img (2).jpg",
                            "projetos/hotel rossi/img (3).jpg",
                            "projetos/hotel rossi/img (4).jpg",
                            "projetos/hotel rossi/img (5).jpg",
                            "projetos/hotel rossi/img (6).jpg",
                            "projetos/hotel rossi/img (7).jpg",
                            "projetos/hotel rossi/img (8).jpg",
                            "projetos/hotel rossi/img (9).jpg",
                            "projetos/hotel rossi/img (10).jpg",
                            "projetos/hotel rossi/img (11).jpg"
                        ],
                        areaDeAtucaoId: 4,
                        ano: 2023
                    }
                ...
                projetos:[
                    {
                        ...
                        imagens: [
                            "projetos/olive/img (1).jpg",
                            "projetos/olive/img (2).jpg",
                            "projetos/olive/img (3).jpg",
                            "projetos/olive/img (4).jpg",
                            "projetos/olive/img (5).jpg",
                            "projetos/olive/img (6).jpg",
                            "projetos/olive/img (7).jpg",
                            "projetos/olive/img (8).jpg",
                            "projetos/olive/img (9).jpg",
                            "projetos/olive/img (10).jpg",
                            "projetos/olive/img (11).jpg"
                        ],
                        areaDeAtucaoId: 5,
                        ano: 2023
                    }, {
                        id: 19,
                        nome: "pizzaria ditalia",
                        local: "Vilhena – RO",
                        ...
                        imagens: [
                            "projetos/pizzaria ditalia/img (1).jpg",
                            "projetos/pizzaria ditalia/img (2).jpg",
                            "projetos/pizzaria ditalia/img (3).jpg",
                            "projetos/pizzaria ditalia/img (4).jpg"
                        ],
                        areaDeAtucaoId: 5,
                        ano: 2024
                    }, {
                        ...
                        descricao: `A Paninoteca é uma casa especializada em paninis e especialidades italianas! Em 2024, precisaram mudar de endereço e realocar a sua cozinha profissional em um espaço reduzido, mas que fosse funcional. Dessa forma, aproveitamos todos os equipamentos  e mobiliários que já eram existentes, promovendo uma grande economia para o cliente, mas trazendo toda a funcionalidade que a operação necessita!`,
                        imagens: [
                            "projetos/paninoteca/img (1).jpg",
                            "projetos/paninoteca/img (2).jpg",
                            "projetos/paninoteca/img (3).jpg",
                            "projetos/paninoteca/img (4).jpg",
                            "projetos/paninoteca/img (5).jpg"
                        ],
                        areaDeAtucaoId: 5,
                        ano: 2024
                    }, {
                        id: 26,
                        nome: "nono pizza e gril",
                        local: "Várzea Grande - MT",
                        ...
                        imagens: [
                            "projetos/nono pizza e gril/img (1).png",
                            "projetos/nono pizza e gril/img (2).png",
                            "projetos/nono pizza e gril/img (3).png",
                            "projetos/nono pizza e gril/img (4).png",
                        ],
                        areaDeAtucaoId: 5,
                        ano: 2024
                    }
            ...
            },
            {
                ...
                Separamos a operação entre cozinha fria para saladas e molhos e cozinha quente para o preparo e expedição dos lanches. Além disso, também reformamos toda a fachada para maior conforto dos motoboys e melhor aspecto visual para os clientes que farão retirada no local!`,
                        imagens: [
                            "projetos/belatto lanches/img (1).png",
                            "projetos/belatto lanches/img (2).png",
                            "projetos/belatto lanches/img (3).png",
                            "projetos/belatto lanches/img (4).png",
                            "projetos/belatto lanches/img (5).png",
                            "projetos/belatto lanches/img (6).png",
                            "projetos/belatto lanches/img (7).png"
                        ],
                        areaDeAtucaoId: 6,
                        ano: 2024
                    },
                    {
                        ...
                        imagens: [
                            "projetos/dam gastrobar/img (1).jpg",
                            "projetos/dam gastrobar/img (2).jpg",
                            "projetos/dam gastrobar/img (3).jpg",
                            "projetos/dam gastrobar/img (4).jpg",
                            "projetos/dam gastrobar/img (5).jpg",
                            "projetos/dam gastrobar/img (6).jpg",
                            "projetos/dam gastrobar/img (7).jpg"
                        ],
                        areaDeAtucaoId: 6,
                        ano: 2024
                    },
                ...
                Além disso, temos a área de cocção de frente para a montagem dos lanches, para que tudo fique perto e à mão dos montadores. Lanche pronto, a bancada da frente já é a saída! Um atendente poderá separar as rotas e pegar a bebida, caso acompanhe o pedido.`,
                        imagens: [
                            "projetos/o paulistinha sanduíches/img (1).jpg",
                            "projetos/o paulistinha sanduíches/img (2).jpg",
                            "projetos/o paulistinha sanduíches/img (3).jpg",
                            "projetos/o paulistinha sanduíches/img (4).jpg"
                        ],
                        areaDeAtucaoId: 6,
                        ano: 2024
                    }, {
                        ...
                        imagens: [
                            "projetos/bnp/img (1).jpg",
                            "projetos/bnp/img (2).jpg",
                            "projetos/bnp/img (3).jpg",
                            "projetos/bnp/img (4).jpg",
                            "projetos/bnp/img (5).jpg"
                        ],
                        areaDeAtucaoId: 6,
                        ano: 2022
                    }
                ...
                projetos:[
                    {
                        ...
                        imagens: [
                            "projetos/confeitaria vilma/img (1).png",
                            "projetos/confeitaria vilma/img (2).png",
                            "projetos/confeitaria vilma/img (3).png",
                            "projetos/confeitaria vilma/img (4).png",
                            "projetos/confeitaria vilma/img (5).png",
                            "projetos/confeitaria vilma/img (6).png",
                            "projetos/confeitaria vilma/img (7).png",
                            "projetos/confeitaria vilma/img (8).png",
                            "projetos/confeitaria vilma/img (9).png"
                        ],
                        areaDeAtucaoId: 7,
                        ano: 2024
                    }, {
                        ...
                        imagens: [
                            "projetos/de panela/img (1).jpg",
                            "projetos/de panela/img (2).jpg",
                            "projetos/de panela/img (3).jpg",
                            "projetos/de panela/img (4).jpg"
                        ],
                        areaDeAtucaoId: 7,
                        ano: 2023
                    }
            ...
            },
            {
                ...
                projetos:[
                    {
                        id: 9,
                        nome: "condominio aquarela dos poemas",
                        local: "SINOP – MT",
                        ...
                        imagens: [
                            "projetos/condominio alameda dos poemas/img (1).jpg",
                            "projetos/condominio alameda dos poemas/img (2).jpg",
                            "projetos/condominio alameda dos poemas/img (3).jpg",
                            "projetos/condominio alameda dos poemas/img (4).jpg"
                        ],
                        areaDeAtucaoId: 9,
                        ano: 2021
                    }, {
                        ...
                        imagens: [
                            "projetos/flor de lotus/img (1).jpg",
                            "projetos/flor de lotus/img (2).jpg",
                            "projetos/flor de lotus/img (3).jpg",
                            "projetos/flor de lotus/img (4).jpg",
                            "projetos/flor de lotus/img (5).jpg",
                            "projetos/flor de lotus/img (6).jpg",
                            "projetos/flor de lotus/img (7).jpg",
                            "projetos/flor de lotus/img (8).jpg"
                        ],
                        areaDeAtucaoId: 9,
                        ano: 2024
                    }, {
                ...
                Como se tratava de um projeto hospitalar, todas as normas de higiene e boas práticas foram levadas ao pé da letra! Por isso, separamos praças por função e também por temperatura de trabalho. Temos uma sala de preparos frios, de preparo quente, de cocção, de ultracongelamento das sobras e montagem das bandejas para os leitos.`,
                        imagens: [
                            "projetos/femina/img (1).jpg",
                            "projetos/femina/img (2).jpg",
                            "projetos/femina/img (3).jpg",
                            "projetos/femina/img (4).jpg",
                            "projetos/femina/img (5).jpg",
                            "projetos/femina/img (6).jpg"
                        ],
                        areaDeAtucaoId: 9,
                        ano: 2022
                    }, {
                        ...
                        imagens: [
                            "projetos/vivans complexo de eventos/img (1).png",
                            "projetos/vivans complexo de eventos/img (2).png",
                            "projetos/vivans complexo de eventos/img (3).png",
                            "projetos/vivans complexo de eventos/img (4).png",
                            "projetos/vivans complexo de eventos/img (5).png",
                            "projetos/vivans complexo de eventos/img (6).png",
                            "projetos/vivans complexo de eventos/img (7).png",
                        ],
                        areaDeAtucaoId: 9,
                        ano: 2021
                    }
        ...
        return {
            ...
            areasDeAtuacaoComProjeto: areasDeAtuacaoComProjeto,
            listaRenderizacao: [],
        }
    },
    methods: {
        fetchProjetos: async function ( filtro) {
            ...
            try {
                const listaFiltrada = this.areasDeAtuacaoComProjeto.filter(projetos => projetos.id == filtro);
                listaFiltrada.length > 0 ? this.listaRenderizacao = listaFiltrada : this.listaRenderizacao = this.areasDeAtuacaoComProjeto;
            }
            catch (error) {
...
<template>
    <BarraDePesquisa :lista="areasDeAtuacao" :mostraBotaoTodos="mostraBotaoTodos"
        @itemSelecionado="fetchProjetos" />

    <section v-for="areaDeAtuacao in listaRenderizacao">
        <h2>{{ areaDeAtuacao.nome }}</h2>
        <div class="container_projetos">    
            <a v-for="projeto in areaDeAtuacao.projetos" class="projetos"
                :href="'/projeto/' + projeto.id + '/' + projeto.nome"
            >
